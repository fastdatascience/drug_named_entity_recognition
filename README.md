...
Wood, T.A., Drug Named Entity Recognition [Computer software], Version 1.0, accessed at https://fastdatascience.com/drug-named-entity-recognition-python-library/, Fast Data Science Ltd (2023)

```
@unpublished{countrynamedentityrecognition,
    AUTHOR = {Wood, T.A.},
    TITLE  = {Drug Named Entity Recognition (Computer software), Version 1.0},
    YEAR   = {2023},
    Note   = {To appear},
}
```
